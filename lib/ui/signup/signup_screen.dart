...
class SignupState extends State<SignupScreen> {
  ...
  void moveToScreen2() {
    setState(() {
      screen = SignupForm2(signupData.firstName, signupData.lastName);
    });
  }

  void moveToScreen3() {
    setState(() {
      screen = SignupForm3(signupData.birthday);
    });
  }
      ...
      child: Scaffold(
          appBar: AppBar(
            ...
            iconTheme: const IconThemeData(
              color:
                  Colors.grey, // Set the color of the back arrow icon to black
            ),
