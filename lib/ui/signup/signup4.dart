...
class _EmailState extends State<SignupForm4> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const TextWidget(
            text: "Enter your email", fontSize: 20, textColor: FBBLUE),
        const TextWidget(
            text: "Enter the email where you can be contacted. "
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return const AlertDialogWidget(
            title: 'Error', text: 'Email already exist');
      },
    );
  }
  ...
  void showErrorlNotification(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return const AlertDialogWidget(
            title: 'Error',
            text: 'Error when try to sent verify code to this email');
      },
    );
  }
}
